...
```
But in order for **line.parse()** to work for the custom struct I had to implement the [FromStr](@/garden/languages/rust/from-str.md) trait. Essentially we need to tell Rust what the logic is for converting a string to an **Instruction**.
